...
def solve_fair_range_Dinkleback_warm_start(points, input_box_indices, qbox_bounds, alpha, beta, epsilon, d=2, delta_base=2, use_dynamic_grid=True, start_gamma=0.0, warm_start_box=None, K_add=None, K_drop=None, color_weights=None, coverage=False, min_coverage=None, fairness_rules=None, diff_matrix=None, ratio_matrix=None):
    ...
    model, S_ino, S_io, S_oi, l_vars, r_vars, sorted_coords, allowed_L_vars, allowed_R_vars = build_model(
        points, input_box_indices, qbox_bounds, epsilon, d, delta_base, use_dynamic_grid, warm_start_box, K_add, K_drop, color_weights=color_weights, coverage=coverage, min_coverage=min_coverage, fairness_rules=fairness_rules, diff_matrix=diff_matrix, ratio_matrix=ratio_matrix)
...
if __name__ == "__main__":
    ...
    try:
        gamma_approx, box_approx = solve_fair_range_Dinkleback_warm_start(
        ...
        if box_approx is not None:
            ...
            gamma, box = solve_fair_range_Dinkleback_warm_start(
                ...
                start_gamma=gamma_approx, warm_start_box=box_approx,
