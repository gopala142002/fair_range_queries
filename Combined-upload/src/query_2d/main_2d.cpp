...
// ========================================================
// This 2D dataset is expected to contain exactly 3 colors
// ========================================================

if (numColors != 3)
{
    cerr
        << "This 2D program expects exactly 3 colors.\n"
...
while (loadConstraintsFromConsole())
{
    ...
    // ====================================================
    // Verify exactly 3 colors in dataset
    // ====================================================

    if (raw.uniqueColorsList.size() != 3)
    {
        cerr
            << "Expected exactly 3 colors, but dataset has "
    ...
    // ====================================================
    // Print coverage color order
    //
    // required[0] -> first color
    // required[1] -> second color
    // required[2] -> third color
    // ====================================================

    if (coverageMode)
    {
        cout
            << "Coverage color order: "
    ...
    while (true)
    {
        ...
        // =================================================
        // Parse exactly 3 coverage requirements
        // =================================================
