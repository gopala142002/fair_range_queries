...
def main():
    ...
    csv_filename = "scratch/combinations_result_alpha_beta_40000_5.csv"
            ...
            for epsilon in eps_to_test:
                for delta in del_to_test:
                    for alpha in alphas:
                        ...
                        print(f"\nRunning Combination: {fair_combo}, alpha={alpha}, beta={beta}")
                
                        # Build constraints
                        input_lines = []
                        if has_diff:
                            input_lines.append("2")
                            input_lines.append(f"Green Blue 1.0 1.0 {epsilon}")
                            input_lines.append(f"Purple Yellow 1.0 1.0 {epsilon}")
                        else:
                            input_lines.append("0")
                            
                        if has_ratio:
                            input_lines.append("1")
                            input_lines.append(f"Red Green {weightA} {weightB} {delta}")
                        else:
                            input_lines.append("0")
