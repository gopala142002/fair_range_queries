...
def main():
    ...
    csv_filename = "scratch/combinations_result_alpha_beta_f1.csv"
                    ...
                    for coverage_percent in cov_to_test:
                        for alpha in alphas:
                            ...
                            if has_diff:
                                ...
                                input_lines.append(f"HARD MEDIUM 1.0 1.0 {epsilon}")
                                input_lines.append(f"SOFT INTERMEDIATE 1.0 1.0 {epsilon}")
                            else:
                                input_lines.append("0")
                            
                            if has_ratio:
                                input_lines.append("1")
                                input_lines.append(f"HARD SOFT {weightA} {weightB} {delta}")
                            else:
                                input_lines.append("0")
