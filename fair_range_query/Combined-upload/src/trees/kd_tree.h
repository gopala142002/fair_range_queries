...
struct KDTree {
    ...
    int findClosestIndexToTarget(const vector<double> &lo, const vector<double> &hi, int target) const;
...
private:
    ...
    void closest(const Node *node, const vector<double> &qlo, const vector<double> &qhi, 
