#include "xtree_opt_cov.h"

static void updateResult(int L,int R,int qL,int qR,double alpha,double beta,
    ...
    else if(t==bestT&&t>=0.0){int wBest=bestR-bestL,wCur=R-L;
