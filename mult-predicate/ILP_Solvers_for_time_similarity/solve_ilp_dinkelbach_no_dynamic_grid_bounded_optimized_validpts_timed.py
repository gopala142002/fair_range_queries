...
def solve_fair_range_Dinkleback_warm_start(points, input_box_indices, qbox_bounds, alpha, beta, epsilon, d=2, start_gamma=0.0, warm_start_box=None, color_weights=None, coverage=False, min_coverage=None, fairness_rules=None, diff_matrix=None, ratio_matrix=None):
    ...
    if DEBUG:
        print(f"Starting Dinkelbach Search for Gamma (No Dynamic Grid)... (Starting at {feasible_gamma})")
...
if __name__ == "__main__":
    ...
    print(f"Solving ILP with Dinkelbach No Dynamic Grid Bounded Optimized ValidPts (alpha={alpha}, beta={beta}, epsilon={epsilon})...")
