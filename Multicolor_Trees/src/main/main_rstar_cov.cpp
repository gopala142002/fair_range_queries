...
int main(int argc, char *argv[]) {
    if(argc<3){cout<<"Usage: main_rstar_cov <input> <num_colors>\n";return 1;}
    ...
    cout<<"R* Tree Coverage mode. Built in "<<chrono::duration_cast<chrono::milliseconds>(t1-t0).count()<<" ms\n";
    ...
    while(true){
        ...
        auto res=queryBestRT_rstar_cov(data,tree,cov,eps,s,en,a,b,required);
